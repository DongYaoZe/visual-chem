...
站点现有四季、十二篇中英双语交互长文；第四季已有原子光谱与分子红外两篇，核磁共振故事仍在计划中：
...
| 04  | 光与结构 | 《氢原子为什么只发出几根线》《为什么有些振动红外光看不见》；后续：《磁场里的结构拼图》 |
...
浏览器引擎从相平衡延伸到热力学、动力学与原子/分子光谱：Antoine/IAPWS 蒸气压、活度系数、泡露点、共沸与杠杆规则；盐水与共晶相界；微观状态计数、Gibbs 山谷、Nernst 电势；0/1/2 级积分速率方程、Arrhenius 温度依赖、Maxwell–Boltzmann 分布和催化能量路径；约化质量修正的氢原子 Rydberg 能级、光子能量与谱系极限；CO₂ 三种教学振动模式、偶极矩变化与基本红外活性判据。每个故事另有场景—中英双语对齐测试，防止文案、舞台和计算状态悄悄分叉。
